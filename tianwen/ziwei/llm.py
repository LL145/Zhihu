...
若附【语境】西洋本命盘块，宜在理由中至少参及一次其盘面事实（七曜落宫、得位、\
相位、上升分府）——盘面事实是排盘数据，白话转述即可、不作引文；其中标注\
"存疑""勿引"之项勿参。若引《占星四书》原文，须逐字照录英文原文并标注 cite_id，\
中文翻译不得充作引文。\
【语境·书桌】之候选断语系按星名机械召回，未必尽合此盘：引用前须自行对照盘面\
星曜庙陷宫支，不合者勿引，尤不得据以立断。
