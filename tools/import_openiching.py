...
FIXES = {
    ...
    # 2026-08 机扫裁定（data/PROOFREADING.md 机扫候核清单节）：
    # 彖传十二「大矣哉」例，颐/大过/解/革四卦但言「时」不言「义」——
    # 库内王弼注 tuan:40 明文「故不言用……故不曰义」，《周易正义》同；
    # 源数据解、革、颐三卦衍「义」（颐并衍逗号），大过不误可证体例
    ("tuan", "iching__40"): ("解之时义大矣哉", "解之时大矣哉"),
    ("tuan", "iching__49"): ("革之时义大矣哉", "革之时大矣哉"),
    ("tuan", "iching__27"): ("颐之时，义大矣哉", "颐之时大矣哉"),
    # 小象误字（爻辞／王弼注／历代注本互证）：
    # 咸九五王弼注「其志浅末」；讼初六爻辞「小有言」；师六五爻辞
    # 「弟子舆尸」；晋初六爻辞「晋如摧如」
    ("xiang", "iching__31_5"): ("志未也", "志末也"),
    ("xiang", "iching__6_1"): ("虽“有小言”", "虽“小有言”"),
    ("xiang", "iching__7_5"): ("“弟子舆师”", "“弟子舆尸”"),
    ("xiang", "iching__35_1"): ("“晋中摧如”", "“晋如摧如”"),
}
